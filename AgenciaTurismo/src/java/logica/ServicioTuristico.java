...
public class ServicioTuristico {
    ...
    @OneToOne
    private TipoServicioTuristico tipoServicio;
    @OneToMany
    ...
    public ServicioTuristico(int id, int codigo_servicio, String nombre, String descripcion_breve, String destino_servicio, double costo_servicio, Date fecha_servicio, TipoServicioTuristico tipoServicio, List<Venta> listaVenta, List<PaqueteTuristico> paqueteTuristico) {
        this.id = id;
    ...
    public TipoServicioTuristico getTipoServicio() {
        return tipoServicio;
    }

    public void setTipoServicio(TipoServicioTuristico tipoServicio) {
        this.tipoServicio = tipoServicio;
    }
